...
public class WallServiceShould {
    ...
    private static final String POST_ID_4 = UUID.randomUUID().toString();
    ...
    private void initMocksBehavior() {
        followee1 = new User(USER_ID_1, USERNAME_1, PASSWORD, ABOUT);
        followee2 = new User(USER_ID_2, USERNAME_2, PASSWORD, ABOUT);
        post1 = new Post(POST_ID_1, USERNAME_1, TEXT, YESTERDAY);
        post2 = new Post(POST_ID_2, USERNAME_2, TEXT, TODAY);
        post3 = new Post(POST_ID_3, USERNAME_2, TEXT, BEFORE_YESTERDAY);
        post4 = new Post(POST_ID_4, USERNAME_3, TEXT, TODAY);
